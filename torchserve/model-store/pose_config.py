...
data_cfg = dict(
    ...
    det_bbox_thr=0.0,
    bbox_file=
    '/private/home/hjessmith/AD_Consent_Data_workspace/mmpose-180k-workspace/train_size-180000_detections.json'
)
train_pipeline = [
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/private/home/hjessmith/AD_Consent_Data_workspace/mmpose-180k-workspace/train_size-180000_dev.json'
    ),
    val=dict(
        type='TopDownCocoDataset',
        img_prefix='',
        ...
        ann_file=
        '/private/home/hjessmith/AD_Consent_Data_workspace/mmpose-dataset-size_workspace/run_2022-06-09_16:19:59.526334/coco_annos/val0.json'
    ),
    test=dict(
        type='TopDownCocoDataset',
        img_prefix='',
...
work_dir = '/private/home/hjessmith/AD_Consent_Data_workspace/mmpose-180k-workspace/workdir'
